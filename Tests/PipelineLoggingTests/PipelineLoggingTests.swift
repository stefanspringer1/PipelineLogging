...
@Suite struct PipelineLoggingTests {
    ...
    @Test func test1() async throws {
        ...
        #expect(collectingLogger.getMessages().map{ $0.description }.joined(separator: "\n") == """
            ...
            Test:     {progress} beginning step step2(during:)@PipelineLoggingTests [@@ step step1(during:)@PipelineLoggingTests -> ]
            Test:         {info} [where am I]: I am in step 2 [@@ step step1(during:)@PipelineLoggingTests -> step step2(during:)@PipelineLoggingTests]
            Test:     {progress} ending step step2(during:)@PipelineLoggingTests [@@ step step1(during:)@PipelineLoggingTests -> ]
            Test: {progress} ending step step1(during:)@PipelineLoggingTests
            """)
